...
public class JwtProviderImpl implements JwtProvider{
    ...
    * */
    ...
    /**
     * Autenticación mediante token y convertir a objeto de tipo usuario
     * @param request
     * @return
     */
    @Override
    public Authentication getAuthentincation(HttpServletRequest request){
    ...
    /**
     * Extraer todos los valores del claim
     * @param request
     * @return
     */
